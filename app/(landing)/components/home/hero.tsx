    ...
    return (
        <section id="hero-section" className="container mx-auto h-screen flex">
            <div className="relative self-center">
                <Image src="/images/img-basketball.svg" width={432} height={432} alt="image sporton" className="grayscale absolute left-10 -top-20"/>
                <div className="relative ml-40 relative w-full">
                    ...
                    <p className="w-1/2 mt-10 leading-loose">
                        ...
                        Experience gear that moves as fast as you do. Premium fabrics. Unmatched comfort. 
                        Limitless motion.
                    </p>
